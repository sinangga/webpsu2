                        ...
                        <div class="col-lg-12 col-md-12">
                            <div class="single_place">
                                <div class="thumb">
                                 ...
                                 <?php 
                                 $query = pg_query("SELECT * FROM pracu_harian ORDER BY id_pracuharian DESC LIMIT 1");
                                 while($data = pg_fetch_array($query)) {
                                    echo("
                                 
                            <a href ='$data[gbr_pracuharian]' target='_blank'>
                                <img src='$data[gbr_pracuharian]'</img></a>
                                 ");}?>
                    </div>
                </div>
            </div>
