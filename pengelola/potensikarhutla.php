...
?>
    <section class="content-header">
      <h1>
       Data Potensi KarHutLa <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-data"><i class="fa fa-file-o"></i> Tambah</button>
      </h1>
    </section> 
    <!-- Main content -->
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <?php 
                  $i = 1;
                    $query = pg_query("SELECT * FROM potensi_karhutla");
                      ...
                      <td align='center'>$i</td>
                                    ...
                                    <td align='center'>$data[gbr_potensikarhutla]</td> 
                                    <td align='center'>
                                    <a href='potensikarhutla-proses.php?hal=delete&id=$data[id_potensikarhutla]' onclick='return confirm(\"Apakah anda yakin akan menghapus data ini?\")'> 
  ...
  if(isset($_POST['upload'])){
        ...
        $char = "pengelola/potensi/karhutla-";
        ...
        if(in_array($file_ext, $allowed_ext) === true){
          if($file_size < 1044070){
            $lokasi = 'potensi/'.$namagbr.'.'.$file_ext;
             //move_uploaded_file($file_tmp, $lokasi);
            $lokasi2 = 'potensi/'.basename($_FILES['file']['name']);
            move_uploaded_file($file_tmp, $lokasi2);
            // $asal='data_kirim/'.$lokasi2;
            rename($lokasi2,$lokasi);
           $in = pg_query("INSERT INTO potensi_karhutla (id_potensikarhutla, namafile, gbr_potensikarhutla)
