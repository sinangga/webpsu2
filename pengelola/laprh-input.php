    <section class="content-header">
      <h1>
        Input Data Laporan Kelembapan Nisbi
      </h1>
    </section> 
    <!-- Main content -->
              ...
              <!-- /.form group -->
                ...
                <div class="form-group">
                    <label>Rata-Rata</label>
                        <input class="form-control" name="rata" required oninvalid="this.setCustomValidity('Isi kelembapan nisbi rata-rata')" oninput="setCustomValidity('')">
                </div>
                <div class="form-group">
                    <label>Maksimum (&deg;C)</label>
                        <input class="form-control" name="max" required oninvalid="this.setCustomValidity('Isi kelembapan nisbi maksimum')" oninput="setCustomValidity('')">
                </div>
                <div class="form-group">
                    <label>Minimum (&deg;C)</label>
                        <input class="form-control" name="min" required oninvalid="this.setCustomValidity('Isi kelembapan nisbi minimum')" oninput="setCustomValidity('')">
                </div>
