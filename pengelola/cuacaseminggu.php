          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <?php 
                  $i = 1;
                    $query = mysql_query("SELECT * FROM pracu_mingguan ");
                      // tampilkan data permukaan selama masih ada
                      while($data = mysql_fetch_array($query)) {
                      echo("
                      <tr class='odd gradeA'>
                      <td align='center'>$i</td>
                                    <td align='center'>$data[tgl_pracumingguan]</td> 
                                    <td align='center'>$data[gbr_pracumingguan]</td> 
                                    <td align='center'>
                                    <a href='lapsuhu-proses.php?hal=delete&id=$data[id_pracumingguan]' onclick='return confirm(\"Apakah anda yakin akan menghapus data ini?\")'> 
