...
?>
          ...
          <div class="box box-success">
            ...
            <div class="box-body">
              <table id="example2" class="table table-bordered table-striped">
                ...
                <?php 
                  $i = 1;
                    $query = pg_query("SELECT * FROM pracu_kalbar");
                      ...
                      <td align='center'>$i</td>
                                    ...
                                    <td align='center'>$data[gbr_pracukalbar]</td> 
                                    <td align='center'>
                                    <a href='cuacakalbar-proses.php?hal=delete&id=$data[id_pracukalbar]' onclick='return confirm(\"Apakah anda yakin akan menghapus data ini?\")'> 
            ...
            <div class="modal-content">
              <div class="modal-header">
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                  ...
                  <h3 class="modal-title">PRAKIRAAN CUACA KALBAR
              </div>
  ...
  if(isset($_POST['upload'])){
        ...
        $char = "pengelola/pracukalbar/hariankalbar-";
        $namafile = $char .$tahun .$bulan .$tgll;
        $lokasifile = $namafile.'.'.$file_ext;;

        if(in_array($file_ext, $allowed_ext) === true){
          if($file_size < 1044070){
      $lokasi = 'pracukalbar/'.$namagbr.'.'.$file_ext;
