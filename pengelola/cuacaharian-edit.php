...
?>
    <section class="content-header">
      <h1>
        Data Prakiraan Cuaca <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-data"><i class="fa fa-file-o"></i> Tambah</button>
      </h1>
    </section> 
    <!-- Main content -->
                  ...
                  $i = 1;
                    $query = mysql_query("SELECT * FROM lap_suhu INNER JOIN tahun INNER JOIN bulan WHERE lap_suhu.id_tahun = tahun.id_tahun AND lap_suhu.id_bulan=bulan.id_bulan");
                      ...
                      <td align='center'>$i</td>
                                    ...
                                    <td align='center'>
                                    <a href='data.php?page=edit_lapsuhu&id=$data[id_lapsuhu]'>
